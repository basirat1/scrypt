...
if ($('.mobile-menu').length) {
	...
	var mobileMenuContent = $('.menu-area .main-menu').php();
...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.php(event.strftime('<div class="time-count day"><span>%D</span><span>Day</span></div><div class="time-count hour"><span>%H</span><span>Hours</span></div><div class="time-count min"><span>%M</span><span>Minute</span></div><div class="time-count sec"><span>%S</span><span>Second</span></div>'));
	});
});
